...
const synonyms = {
    'pasta':      { terms: ['spaghetti', 'penne', 'rigate', 'fusilli', 'linguine', 'tagliatelle', 'pasta'],
                    exclude: ['dentifricio', 'toothpaste', 'sfoglia', 'frolla'] },
    'pane':       { terms: ['bread', 'pane', 'loaf', 'sandwich'],
                    exclude: ['panettone', 'grissini', 'paneer', 'panforte', 'pandoro'] },
    'bread':      { terms: ['bread', 'pane', 'sandwich', 'loaf'],
                    exclude: ['panettone', 'grissini', 'paneer', 'panforte', 'pandoro'] },
    'latte':      { terms: ['latte', 'milk'],
                    exclude: ['mozzarella', 'formaggio', 'cheese', 'fior di latte', 'burrata', 'ricotta', 'mascarpone', 'stracchino', 'crescenza', 'fiordilatte', 'latticini', 'cioccolato', 'chocolate', 'biscotti', 'cookies'] },
    ...
    'acqua':      { terms: ['water', 'acqua'],
                    exclude: ['acquavite', 'colonia', 'profumo', 'toilette', 'watermelon'] },
    'water':      { terms: ['water', 'acqua'],
                    exclude: ['acquavite', 'colonia', 'profumo', 'toilette', 'watermelon'] },
    'mozzarella': { terms: ['mozzarella', 'bufala', 'fior di latte', 'fiordilatte'],
                    exclude: ['ricotta', 'yogurt', 'burrata', 'stracciatella'] },
    'uova':       { terms: ['uova', 'eggs', 'egg'],
                    exclude: ['eggplant', 'nuova'] },
